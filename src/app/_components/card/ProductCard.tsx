...
<Card
  ...
  className={`
    ...
    bg-body/95 shadow-sm rounded-lg 
...
>
  ...
  "
>
  <IoMdCart size={20} className="text-head hover:text-white transition-colors duration-300" />
</div>
...
<div
  ...
  "
>
  <CiHeart size={20} className="text-head hover:text-white transition-colors duration-300" />
</div>
